...
case "$1" in
    "train")
        ...
        python -m src.training --config configs/default.yaml
        ;;
    "evaluate")
        ...
        python -m src.evaluation "$2" --config configs/default.yaml
        ;;
    "test")
        echo "Running tests..."
        cd /app
    ...
    "interactive")
        ...
        python -m src.evaluation "$2" --config configs/default.yaml --interactive
        ;;
    "jupyter")
